...
public:
    TreeNode* deleteHelper(TreeNode* root, unordered_set<int>& st, vector<TreeNode*>& result) {
        ...
        /* agr node ko delete kiye toh uske direct left and right
           nodes bachenge jo ki new forest ke root honge  */
    ...
    vector<TreeNode*> delNodes(TreeNode* root, vector<int>& to_delete) {
        ...
        /* Agar root ko delete nhi krna toh vo v ek forest banayega  */
        if (st.find(root->val) == st.end()) {
